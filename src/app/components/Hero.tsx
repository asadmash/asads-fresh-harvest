    ...
    <section className="h-auto w-full bg-[url(/mobile-hero-bg.png)] lg:bg-[url(/desktop-hero-bg.png)] @container bg-cover relative z-10 bg-right">
      <div className="container_inner z-30">
        ...
        <div className=" w-full sm:w[400px] md:w-[500px] mt-30 md:mt-50 left-0">
          ...
          <h1 className="text-2xl text-black sm:text-4xl md:text-6xl py-4 md:py-8 font-bold">
        ...
        <div className=" ml-5 md:ml-20 mt-5 flex">
          ...
          <div className="flex px-2 py-2 bg-grey-card text-sm xsm:text-lg md:text-xl rounded-2xl items-center gap-2">
            <div>
              ...
              <h2>Fresh Salad</h2>
              <p>
                <span className="text-green">Up to </span>
            ...
            <div>
              <Image
                ...
                height={100}
                alt="salad"
                className="w-[50px] h-[50px] xsm:w-[80px] xsm:h-[80px] sm:w-[100px] sm:h-[100px]"
              />
            </div>
          </div>
        </div>
